...
namespace CloudWeb.Util
{
    public static class ConverterUtil
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static double PriceToWan(double price)
        {
            double resultPrice = 0;
            resultPrice = price / 10000;
            return resultPrice;
        }
        ...
        /// <returns></returns>
        public static string StringSplit(int [] array)
        {
            string[] strs = Array.ConvertAll<int, string>(array, delegate (int input) { return input.ToString(); });
        ...
        public static string ToCnPrice(this decimal price, string format = "0.00")
        {
            ...
            return string.Format("￥ {0}", price.ToString(format));
        }
        ...
        /// <returns></returns>
        public static int ToMinite(DateTime dateTime, DateTime limit)
        {
            return (limit - dateTime).Minutes;
        }


        public static int FinishCount(DateTime dateTime, DateTime limit)
        {
            if (dateTime.ToShortDateString() == "0001.01.01" || limit.ToShortDateString() == "0001.01.01")
            {
                return 0;
            }

            int minites = (limit - dateTime).Minutes;
            int a = 0;
            if (minites > 0)
                a = 1;
            return a;
        ...
        /// 计算积分
        /// </summary>
        /// <param name="dateTime">完成时间</param>
        /// <param name="limit">限制时间</param>
        /// <returns></returns>
        public static int GetIntegral(DateTime dateTime, DateTime limit)
        {
            if (dateTime.ToShortDateString() == "0001.01.01" || limit.ToShortDateString() == "0001.01.01")
            {
                return 0;
        ...
        public static string ToPercent(double a, double b)
        {
            ...
            return string.Concat(c.ToString("f2"), "%");
        }


        public static double ToDouble(double a, double b)
        {
            double c = 0;
            if (b > 0)
            {
        ...
        public static double GetX(string str, double x = 0)
        {
            double result = x;
        ...
        public static double GetY(string str, double x = 0)
        {
            double result = x;
            if (double.TryParse(str, out result))
                x = result;
