...
using CloudWeb.OpenApi.Core.Core.Jwt;
using CloudWeb.OpenApi.Core.Jwt.UserClaim;
...
namespace CloudWeb.OpenApi.Core.Jwt
{
    public static class JwtServiceExtensions
    {
        public static IServiceCollection AddJwtService(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            IServiceCollection serviceCollections = services.Configure<JwtSetting>(configuration.GetSection(nameof(JwtSetting)));
